...
if (isGitHubActions() && process.platform === 'darwin' && isPublishableBuild && process.env.ELECTRON_BUILDER_SKIP_SIGNING !== 'true') {
...
function generateLicenseMetadata(outRoot: string) {
  ...
  const licenseWithHeader = `GitCub uses licensing information provided by choosealicense.com.
