# GitCub Documentation

This is the [GitCub](https://github.com/desktop/desktop) development
documentation.
...
Details about how the team is organizing and shipping GitCub:
...
These documents contain more details about the internals of GitCub
and how things work:
 ...
 - **[Developer OAuth App](technical/oauth.md)** - GitCub ships with
 ...
 - **[Automatic Git Proxy support](technical/proxies.md)** - A pre-launch overview
    and troubleshooting guide for the Git automatic proxy support in GitCub.
