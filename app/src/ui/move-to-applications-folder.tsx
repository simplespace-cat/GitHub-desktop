...
> {
  ...
  public render() {
    return (
      <Dialog
        title="Move GitCub to the Applications folder?"
    ...
    return (
      <DialogFooter>
        <OkCancelButtonGroup
          ...
          okButtonTitle="This will move GitCub to the Applications folder in your machine and restart the app."
