...
export class AppStore extends TypedBaseStore<IAppState> {
   ...
   * in their `%AppData%/Roaming/GitCub/Preferences.js` denoted by the
        ...
        if (match === null) {
          this.emitError(
            new ExternalEditorError(
              `No suitable editors installed for GitCub to launch. Install ${suggestedExternalEditor.name} for your platform and restart GitCub to try again.`,
