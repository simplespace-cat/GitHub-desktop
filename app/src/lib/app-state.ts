...
export interface IBranchesState {
   ...
   * GitCub and GitHub.com default to using 'main' as the default branch.
   *
   * GitCub users are able to configure the `init.defaultBranch` Git
...
export interface IChangesState {
  ...
  /**
   * The latest GitCub stash entry for the current branch, or `null`
